...
<!-- Content Header (Page header) -->
    ...
    <section class="content" style="color:#000">
      ...
      <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 btn-primary" style="border-radius: 20px;">
          <br>
          <a href="{{ url('administrator/stocks')}}">
          <span class="count_top" style="color:#000;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fa fa-industry"></i >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>Vendors</b></span>
           <hr>
